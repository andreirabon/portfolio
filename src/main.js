...
<div class="bg-white dark:bg-gray-900">
			...
			<div class="relative isolate px-6 pt-14 lg:px-8">
				<div
					...
					aria-hidden="true">
					<div
						class="relative left-[calc(50%-11rem)] aspect-[1155/678] w-[36.125rem] -translate-x-1/2 rotate-[30deg] bg-gradient-to-tr from-[#48c9b0] opacity-30 sm:left-[calc(50%-30rem)] sm:w-[72.1875rem]"
						style="
							clip-path: polygon(
								74.1% 44.1%,
								100% 61.6%,
				...
				<div class="mx-auto max-w-2xl py-16 sm:py-24 lg:py-32">
					...
					<div class="text-center">
						<h2
							class="text-4xl font-semibold tracking-tight text-balance text-gray-900 dark:text-gray-100 sm:text-6xl font-inter">
							a Web developer based in the Philippines.
						</h2>
						<p
							class="mt-6 text-justify text-lg font-medium text-pretty text-gray-500 dark:text-gray-400 sm:text-xl/8 max-w-prose mx-auto font-inter">
							With three years of dedicated experience as a
							<span class="font-semibold">Quality Assurance Tester</span>. I'm
							now refocusing on my primary expertise as a
							<span class="font-semibold">Web Developer</span>, specializing in
							<span class="font-semibold">React</span>. This transition enables
							me to leverage my background in quality assurance in conjunction
							with my development skills to create efficient and effective
				...
				<div
					...
					aria-hidden="true">
					<div
						class="relative left-[calc(50%+3rem)] aspect-1155/678 w-[36.125rem] -translate-x-1/2 bg-linear-to-tr from-[#48c9b0] opacity-30 sm:left-[calc(50%+36rem)] sm:w-[72.1875rem]"
						style="
							clip-path: polygon(
								74.1% 44.1%,
								100% 61.6%,
